<?php 
include 'mojopy_merchant_api.php';?>
<!DOCTYPE HTML>
<html>
<head>
...
<script src="mojopay/js/functions.js"></script>
  ...
  <div class="slideshow"  style="color:#FFFFFF"> 
		...
		<?php }?>
                ...
                <div class="applicationform_bg">
                  <table class="applicationform_table"  cellpadding="2" cellspacing="10">
                    ...
                    <tr>
                      ...
                      <td>
                      <textarea style="width:300px;height:85px" wrap="hard" class="message_txtbox" name="detailExplanation" ><?php echo $detailExplanation;?></textarea></td>
                    </tr>
                    <tr>
                      <th scope="row">&nbsp;</th>
                      <td>&nbsp;</td>
				...
				<div class="product_search_indent">
					...
					<tbody><tr>
						<td><span class="validation_info">*</span>Name:<br>
						 <input type="text" id="OwnerName1" value="<?php echo $name1;?>" class="text_box" name="name1"></td>
						<td><span class="validation_info">*</span>Title:(Owner,Pres.,CEO,etc.)<br>
						<input type="text" id="OwnerTitle1" value="<?php echo $title1;?>" class="text_box" name="title1"></td>
					</tr>
					<tr>
						<td><span class="validation_info">*</span>Owner ship %:<br>
						 <input type="text" id="OwnerOwnership1" value="<?php echo $ownership1;?>" maxlength="3" onKeyPress="return numbersonly(this, event)" class="text_box" name="ownership1">						</td>
						<td><span class="validation_info">*</span>SSN:<br>
						<input type="text" id="OwnerSocialSecurityNumber1" value="<?php echo $socialSecurityNumber1;?>" maxlength="9" onBlur="formatSSNNumber('OwnerSocialSecurityNumber1')" class="text_box" name="socialSecurityNumber1">						</td>
					</tr>					
					<tr>
						<td>Home address:<br>
						 <input type="text" id="OwnerHomeAddress1" value="<?php echo $homeAddress1;?>" class="text_box" name="homeAddress1">						</td>
						<td>Home city:<br>
						<input type="text" id="OwnerCity1" value="<?php echo $city1;?>" class="text_box" name="city1"></td>
					</tr>
					<tr>
						<td>Home State:<br>
						<select id="OwnerState1" class="text_box" style="width:320px;" name="state1">
							<option value="">-Select State-</option>
						...
						<td>Home zip:<br>
						<input type="text" id="OwnerZip1" value="<?php echo $zip1;?>" maxlength="5" class="text_box" name="zip1"></td>
					</tr>
					<tr>
						<td>Date of Birth:(MM/DD/YYYY)<br>
						 <input type="text" id="OwnerDob1" value="<?php echo $dob1;?>" class="text_box" name="dob1"></td>
						<td><span class="validation_info">*</span>Home/Cell Phone:<br>
						<input type="text" id="OwnerHomePhone1" value="<?php echo $homePhone1;?>" maxlength="10" onBlur="formatPhoneNumber('OwnerHomePhone1')" onKeyPress="return numbersonly(this, event)" class="text_box" name="homePhone1"></td>
					</tr>
					<tr>
						<td><span class="validation_info">*</span>Driver's License #<br>
						 <input type="text" id="OwnerLicenceNumber1" value="<?php echo $licenceNumber1;?>" class="text_box" name="licenceNumber1">
						</td>						
					</tr>	
					...
					<span style="" id="owner-remove"></span>					
					</div>
				</div>
			</div>
			...
			<div class="step_inner mart25">
              <div class="product_search_indent">
                ...
                <span class="validation_info">&nbsp;</span>
                  <table style="width:95%" class="applicationform_table" cellspacing="7px" cellpadding="0px">
                    <tbody><tr>
                      <td><span class="validation_info">*</span>Please estimate what your average monthly visa & mc volume will be:($)<br>
                       <input type="text" id="MerchanttransactionAvgMonVisaVolume" value="<?php echo $avgMonVisaVolume;?>" class="text_box" name="avgMonVisaVolume"></td>
                    </tr>
                    <tr>
                      <td><span class="validation_info">*</span>Please estimate what your average transaction size will be:($)<br>
                      <input type="text" id="MerchanttransactionAvgVisaTicket" value="<?php echo $avgVisaTicket;?>" class="text_box" name="avgVisaTicket"></td>
                    </tr>
                    <tr>
                  ...
                  <table style="width:95%" class="applicationform_table"  cellpadding="2" cellspacing="10">
                    ...
                    <tr>
                  		<td colspan="2"><div class="sub_title">Bank Information - Electronic Fund Transfer Authorization</div><br><br><img title="Shopping Online" alt="Shopping Online" src="images/sample-cheque.jpg"></td>
                  	</tr>
                    
                    <tr>
                            <td> <br><span class="validation_info">*</span>Account Holder Name:<br>
                ...
                <div class="applicationform_bg">
                  ...
                  <td>                     
                     <tr>
					  ...
					  <td width="72%" align="left" valign="middle"><input type="text" name="name" id="name" class="name text_box" style="width:50%" value="<?php echo $name; ?>"></td>
					  </tr>
					  <tr>
                        ...
                        <br>
                        <ul class="sigNav" style="width:50%">
                     ...
                     <tr>
					  <td align="left" class="rpadnone"><span class="validation_info">*</span>Security Text</td>
            ...
            <div class="step_inner mart25">   
                ...
                <div class="applicationform_bg">
                  <table class="applicationform_table" style="width:95%"  cellpadding="2" cellspacing="10">
