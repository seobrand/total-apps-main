<?php include 'totalapps_merchant_api.php';
//echo '<pre>';
		//print_r($_SESSION);
		
		
	
		$location=explode(',',$_SESSION['My_profile']['location']['name']);
		
		if(isset($location[0])) $legalCity=$location[0];
		if(isset($location[1])) $legalState=$location[1];
		if(isset($location[2])) $legalCountry=$location[2];
		
		
		if(is_array($_SESSION)){
		$contactEmail=$_SESSION['My_profile']['email'];
		$contactName=$_SESSION['My_profile']['name'];
		$merchantURL=$_SESSION['My_profile']['website'];
		$dob1=$_SESSION['My_profile']['birthday'];
		$gender=$_SESSION['My_profile']['gender'];
...
<link href="css/totalapps.com/styles.css" rel="stylesheet" type="text/css" media="all"> -->
<link href="css/totalapps.com/new_ui/reset.css" rel="stylesheet" type="text/css" media="all">
<link href="css/totalapps.com/new_ui/responsive.css" rel="stylesheet" type="text/css" media="all">
<link href="css/totalapps.com/new_ui/styles.css" rel="stylesheet" type="text/css" media="all">
<link href="css/totalapps.com/new_ui/normalize.css" rel="stylesheet" type="text/css" media="all">
...
//(function(jQuery){
	jQuery(document).ready(function(){
		...
		//alert("ok");
	        jQuery.oauthpopup({
	            path: 'http://total-apps.net/merchant_full_api/fb-login.php',
				width:600,
				height:300,
	            callback: function(){
		...
		<?php } ?>
			...
			<div class="application_form">
              <div class="product_search_indent">
                <div class="started_title">Business Profile</div>
                <div class="applicationform_bg">
                <span class="validation_info_new">&nbsp;* All fields marked with a red asterisk character are mandatory.</span>
                  <div class="totalapps_form_outer">
                  <table class="applicationform_table">
                    <tbody><tr>
                      <th scope="row"><span class="validation_info">*</span>LEGAL NAME:</th>
                      <td><input type="text" id="MerchantMerchantName" value="<?php echo $merchantName;?>" maxlength="255" class="input_start" name="merchantName"></td>
                    </tr>
                    <tr>
                      <th scope="row"> LEGAL ADDRESS: </th>
                      <td><input type="text" id="MerchantLegalAddress" value="<?php echo $legalAddress;?>" maxlength="500" class="input_start" name="legalAddress">(NO PO BOX)</td>
                    </tr>
                    <tr>
                      <th scope="row"> LEGAL ADDRESS #2: </th>
                      <td><input type="text" id="MerchantLegalAddress2" class="input_start" name="legalAddress2" value="<?php echo $legalAddress2;?>"></td>
                    </tr>
                    <tr>
                      <th scope="row"> LEGAL CITY: </th>
                      <td><input type="text" id="MerchantLegalCity" value="<?php echo $legalCity;?>" maxlength="200" class="input_start" name="legalCity"></td>
                    </tr>
                    <tr>
                      <th scope="row">LEGAL STATE:</th>
                      <td><select id="MerchantLegalState" class="input_start selectbox" name="legalState">
                    ...
                    <tr>
                      ...
                      <td><input type="text" id="MerchantLegalZip" value="<?php echo $legalZip;?>" maxlength="5" class="input_start" name="legalZip">                        (5 digits)</td>
                    </tr>
                    <tr>
                      <th scope="row"><span class="validation_info">*</span>BUSINESS PHONE:</th>
                      <td><input type="text" id="MerchantContactPhone" value="<?php echo $contactPhone;?>" maxlength="10" onBlur="formatPhoneNumber('MerchantContactPhone')" class="input_start" name="contactPhone"></td>
                    </tr>
                    <tr>
                      <th scope="row"> EIN or SSN Tax ID#:</th>
                      <td><input type="text" id="MerchantFederalTaxId" value="<?php echo $federalTaxId;?>" maxlength="9" class="input_start" name="federalTaxId">(9 digits)</td>
                    </tr>
                    <tr>
                      <th scope="row">BUSINESS START DATE:</th>
                      <td><input type="text" id="MerchantStartDate" value="<?php echo $startDate;?>" maxlength="15" class="input_start" name="startDate">                        (mm/dd/yyyy)</td>
                    </tr>
                    <tr>
                      <th scope="row"><span class="validation_info">*</span>PRIMARY EMAIL CONTACT:</th>
                      <td><input type="text" id="MerchantContactEmail" value="<?php echo $contactEmail;?>" maxlength="255" class="input_start" name="contactEmail"></td>
                    </tr> 
                    <tr>
                      <th scope="row">PRIMARY CONTACT NAME:</th>
                      <td><input type="text" id="MerchantContactName" value="<?php echo $contactName;?>" maxlength="255" class="input_start" name="contactName"></td>
                    </tr>                    
                   <tr>
                      <th scope="row">BUSINESS TYPE:</th>
                      <td><select class="input_start selectbox" id="merchantAccountCategory" name="accountCategory">
                    ...
                    <tr>
                      ...
                      <td><select id="MerchantMerchantType" class="input_start selectbox" name="merchantType">
                   	...
                   	<input type="hidden" id="referral" value="<?php if($_GET['RefID']!=""){ echo trim($_GET['RefID']); }?>" maxlength="10" class="input_start" name="referalID"></td>
                   <tr>
                      <th scope="row">&nbsp;</th>
                      <td>&nbsp;</td>
                    </tr>
                ...
                <div class="applicationform_bg">
                  <table class="applicationform_table">
                    <tbody><tr>
                      ...
                      <td><input type="text" id="MerchantMerchantDBA" value="<?php echo $merchantDBA;?>" maxlength="255" class="input_start" name="merchantDBA"><!-- <input type="checkbox" onclick="sameAsLegalInfo()" id="sameas">
                        same above --> </td>
                    </tr>
                    <tr>
                      <th scope="row"> DBA ADDRESS: </th>
                      <td><input type="text" id="MerchantDbaAddress" value="<?php echo $dbaAddress;?>" maxlength="500" class="input_start" name="dbaAddress">(NO PO BOX)</td>
                    </tr>
                    <tr>
                      <th scope="row"> DBA CITY: </th>
                      <td><input type="text" id="MerchantDbaCity" value="<?php echo $dbaCity;?>" maxlength="255" class="input_start" name="dbaCity"></td>
                    </tr>
                    <tr>
                      <th scope="row">DBA STATE:</th>
                      <td><select id="MerchantDbaState" class="input_start selectbox" name="dbaState">
						<option value="">-Select State-</option>
                    ...
                    <tr>
                      ...
                      <td><input type="text" id="MerchantDbaZip" value="<?php echo $dbaZip;?>" maxlength="5" class="input_start" name="dbaZip">                        (5 digits)</td>
                    </tr>
                    <tr>
                      <th scope="row">CUSTOMER SERVICE PHONE:</th>
                      <td><input type="text" id="MerchantCustomerServicePhone" value="<?php echo $customerServicePhone;?>" maxlength="12" onBlur="formatPhoneNumber('MerchantCustomerServicePhone')" class="input_start" name="customerServicePhone"></td>
                    </tr>
                    <tr>
                      <th scope="row">FAX # (Optional):</th>
                      <td><input type="text" id="MerchantBusinessFax" value="<?php echo $businessFax;?>" maxlength="255" class="input_start" name="businessFax"></td>
                    </tr>
                    <tr>
                      <th scope="row">WEBSITE URL:</th>
                      <td><input type="text" id="MerchantMerchantURL" value="<?php echo $merchantURL;?>" maxlength="255" class="input_start" name="merchantURL"></td>
                    </tr>
                    <tr>
                      <th scope="row"><span class="validation_info">*</span>MONTHLY SALES VOLUME($):</th>
                      <td><input type="text" id="MerchantVolume" value="<?php echo $volume;?>" maxlength="255" class="input_start" name="volume"></td>
                    </tr>
                    <tr>
                      <th scope="row">ABOUT YOUR BUSINESS:</th>
                      <td>
                      <textarea rows="5" cols="29" wrap="hard" class="input_start" name="detailExplanation"><?php echo $detailExplanation;?></textarea></td>
                    </tr>                    
                  </tbody></table>
                  <div class="clear"></div>
                </div>
				...
				<div class="product_search_indent">
					...
					<tbody><tr>
						<td><span class="validation_info">*</span>Name:<br>
						 <input type="text" id="OwnerName1" value="<?php echo $name1;?>" class="input_start" name="name1"></td>
						<td><span class="validation_info">*</span>Title:(Owner,Pres.,CEO,etc.)<br>
						<input type="text" id="OwnerTitle1" value="<?php echo $title1;?>" class="input_start" name="title1"></td>
					</tr>
					<tr>
						<td><span class="validation_info">*</span>Owner ship %:<br>
						 <input type="text" id="OwnerOwnership1" value="<?php echo $ownership1;?>" maxlength="3" onKeyPress="return numbersonly(this, event)" class="input_start" name="ownership1">						</td>
						<td><span class="validation_info">*</span>SSN:<br>
						<input type="text" id="OwnerSocialSecurityNumber1" value="<?php echo $socialSecurityNumber1;?>" maxlength="9" onBlur="formatSSNNumber('OwnerSocialSecurityNumber1')" class="input_start" name="socialSecurityNumber1">						</td>
					</tr>					
					<tr>
						<td>Home address:<br>
						 <input type="text" id="OwnerHomeAddress1" value="<?php echo $homeAddress1;?>" class="input_start" name="homeAddress1">						</td>
						<td>Home city:<br>
						<input type="text" id="OwnerCity1" value="<?php echo $city1;?>" class="input_start" name="city1"></td>
					</tr>
					<tr>
						<td>Home State:<br>
						<select id="OwnerState1" class="input_start selectbox" name="state1">
							<option value="">-Select State-</option>
						...
						<td>Home zip:<br>
						<input type="text" id="OwnerZip1" value="<?php echo $zip1;?>" maxlength="5" class="input_start" name="zip1"></td>
					</tr>
					<tr>
						<td>Date of Birth:(MM/DD/YYYY)<br>
						 <input type="text" id="OwnerDob1" value="<?php echo $dob1;?>" class="input_start" name="dob1"></td>
						<td><span class="validation_info">*</span>Home/Cell Phone:<br>
						<input type="text" id="OwnerHomePhone1" value="<?php echo $homePhone1;?>" maxlength="10" onBlur="formatPhoneNumber('OwnerHomePhone1')" onKeyPress="return numbersonly(this, event)" class="input_start" name="homePhone1"></td>
					</tr>
					<tr>
						<td><span class="validation_info">*</span>Driver's License #<br>
						 <input type="text" id="OwnerLicenceNumber1" value="<?php echo $licenceNumber1;?>" class="input_start" name="licenceNumber1">
						</td>						
					</tr>	
			...
			<div class="application_form mart25">
              <div class="product_search_indent">
                ...
                <span class="validation_info">&nbsp;</span>
                  ...
                  <table style="width:95%" class="applicationform_table">
                    ...
                    <tr>
                      <td><span class="validation_info">*</span>Please estimate what your average monthly visa & mc volume will be:($)<br>
                       <input type="text" id="MerchanttransactionAvgMonVisaVolume" value="<?php echo $avgMonVisaVolume;?>" class="input_start" name="avgMonVisaVolume"></td>
                    </tr>
                    <tr>
                      <td><span class="validation_info">*</span>Please estimate what your average transaction size will be:($)<br>
                      <input type="text" id="MerchanttransactionAvgVisaTicket" value="<?php echo $avgVisaTicket;?>" class="input_start" name="avgVisaTicket"></td>
                    </tr>
                    <tr>
                      <td><span class="validation_info">*</span>Please estimate what your maximum transaction size will be:($)<br>
                      <input type="text" id="MerchanttransactionHighestTicketAmount" value="<?php echo $highestTicketAmount;?>" class="input_start" name="highestTicketAmount"></td>
                    </tr>                   
                    <tr>
                      <td> Do you currently accept Visa-MC at this or any other business?<br>
                        ...
                        <label><strong>No</strong></label><br/><br/></td>
                    </tr>
                    <tr height="35">
                      <td>Refund policy:<br>
                       <select id="MerchantDescribePolicy" class="input_start selectbox" name="describePolicy">
                 ...
                 <div class="transaction_table">
                  <table class="applicationform_table account_holder01">
                  	<tbody>                  	
                  	<tr>
                       <td> <span class="validation_info">*</span>Account Holder Name:<br>
                        <input type="text" id="MerchantBankContact" value="<?php echo $bankContact;?>" maxlength="255" class="input_start" name="bankContact"></td>
                     </tr>
                    <tr>
                            <td> <span class="validation_info">*</span>ABA/Routing #:<br>
                              <input type="text" id="MerchantTransitNumber" value="<?php echo $transitNumber;?>" maxlength="9" class="input_start" name="transitNumber"></td>
                          </tr>
                    <tr>
                            <td> <span class="validation_info">*</span>DDA/Account #:<br>
                              <input type="text" id="MerchantAccountNumber" value="<?php echo $accountNumber;?>" maxlength="255" class="input_start" name="accountNumber"></td>
                          </tr>
                    <tr>
                         <td>Account Type:<br>
			...
			<div class="application_form mart25">
              <div class="product_search_indent">
                ...
                <div class="applicationform_bg upload_signature01">
                  <table class="applicationform_table">
                  <td>                     
                     <tr>
					  <th scope="row"><span class="validation_info">*</span>Print your name</td>
					  <td align="left" valign="middle"><input type="text" name="name" id="name" class="name input_start" style="width:50%" value=""></td>
					  </tr>
					  <tr>
					  	<th scope="row">Review your signature</td>
						<td align="left" valign="middle"><ul class="sigNav" style="width:50%">
            ...
            <div class="product_search_title">Enter Security Text!</div>           
                <div class="applicationform_bg security_form">
                  <table class="applicationform_table">
                     <tr>
					  <th scope="row"><span class="validation_info">*</span>Security Text</td>
					  <td align="left" valign="middle">
					  	<img src="captcha.php" id="captcha" style="float:left;padding-bottom:10px"/><br/>
						<span class="captcha_txt" onClick="document.getElementById('captcha').src='captcha.php?'+Math.random();" id="change-image">Can't read? Change text.</span>
						<input type="text" name="captcha_val" id="captcha_val" class="input_start textbox01" autocomplete="off" maxlength="20"></td>
					  </tr>					  
                  </table>
                  <div class="clear"></div>
                </div> 
			...
			<div class="form_button"><br>
				<p class="login_facebook">
                <a href="#" onClick="return false;"><img src="http://www.total-apps.com//templates/total_apps/images/login-facebook.png" id="facebookimg" ></a>
              </p>
			  <br>
				<br>
