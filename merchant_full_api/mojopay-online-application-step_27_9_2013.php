<?php include 'mojopy_merchant_api.php';?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="product_search_main">
		...
		<?php }?>
                  ...
                  <td>                     
                     <tr>
					  ...
					  <tr>
						...
						<div class="sig sigWrapper" style="width:350px">
						  <div class="typed"><?php echo $output; ?></div>
						  <canvas class="pad" width="350" height="150"><?php echo $output; ?></canvas>
           ...
           <div class="form_button">
			...
			<div class="clear mart25" style="float:left; width:100%;">&nbsp;&nbsp;</div>
			<div class="clear"></div>
			<div class="clear"></div>
		</form>
	</div>
