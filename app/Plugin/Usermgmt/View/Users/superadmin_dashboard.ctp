...
function editAppointment(app_id)
{
	...
	if(app_id!=null || app_id!='')
	{
		...
		var url='';
		url='<?php echo FULL_BASE_URL.router::url('/',false).'superadmin/appointments/editappointment'?>/'+app_id;
...
//
//// code for loading ajax chart //
//jQuery(document).ready(function(){
//
//// ajax for pie chart//
//     jQuery.ajax({
//        url: "usermgmt/users/pieChart",						
//        type: "get",
//        dataType: "html",
//        error: function(){
//                jQuery('#pie_chart').html( "<p>Page Not Found!!</p>" );
//        },
//        beforeSend: function(){
//            $('#loader_pie').show();
//        },
...
//                jQuery('#pie_chart').html( strData );
//        }
//    }); 
//    
//    // ajax for Column chart//
//    jQuery.ajax({
//        url: "usermgmt/users/columnChart",						
//        type: "get",
//        dataType: "html",
//        error: function(){
//                jQuery('#column_chart').html( "<p>Page Not Found!!</p>" );
//        },
//        beforeSend: function(){
//            $('#loader_column').show();
//        },
...
//        },
//        success: function( strData ){
//                jQuery('#column_chart').html( strData );
//        }
//    });    
//    
//    // ajax for Volume chart//
//     jQuery.ajax({
//        url: "usermgmt/users/volumeChart",						
//        type: "get",
//        dataType: "html",
//        error: function(){
//                jQuery('#volume_chart').html( "<p>Page Not Found!!</p>" );
//        },
//        beforeSend: function(){
//            $('#loader_volume').show();
//        },
...
//        },
//        success: function( strData ){
//                jQuery('#volume_chart').html( strData );
//        }
//    });    
//    
//    // ajax for ytd volume chart//
//    
//     jQuery.ajax({
//        url: "usermgmt/users/ytdVolumeChart",						
//        type: "get",
//        dataType: "html",
//        error: function(){
//                jQuery('#ytdvolume_chart').html( "<p>Page Not Found!!</p>" );
//        },
//        beforeSend: function(){
//            $('#loader_ytd').show();
//        },
...
//        },
//        success: function( strData ){
//                jQuery('#ytdvolume_chart').html( strData );
//        }
//    });  
//    
//    // ajax for load application list//
//    
//     jQuery.ajax({
//        url: "usermgmt/users/applicationList",						
//        type: "get",
//        dataType: "html",
//        error: function(){
//                jQuery('#application_list').html( "<p>Page Not Found!!</p>" );
//        },
//        beforeSend: function(){
//            $('#loader_application').show();
//        },
//        complete: function(){
//            $('#loader_application').hide();
//        },
//        success: function( strData ){
//                jQuery('#application_list').html( strData );
//        }
//    });
//});
</script>
