                ...
                <div class="display_row">
                  <div class="table">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <th width="13%" align="center" valign="top" scope="col"> User </th>
                        <th width="13%" align="center" valign="top" scope="col"> Date</th>
                        <th width="10%" align="center" valign="top" scope="col">Entered By</th>
                        <th width="40%" align="center" valign="top" scope="col"> Note</th>
                      <!-- <th width="4%" align="left" valign="top" scope="col">&nbsp;</th>-->
                        <th width="5%" align="center" valign="top" scope="col">&nbsp;</th>
                      </tr>
                      <?php foreach ($agentRec as $agentRec){ ?>
                      <tr>
                        <td align="center" valign="top"><!--<?php echo $this->Html->link(__($agentRec['Agentnote']['userID']), array('action' => 'edit', $agentRec['Agentnote']['agentNoteID'])); ?>-->
                        <?php echo  $common->getAgentName($agentRec['Agentnote']['agentNoteID']);  ?>
                        </td>
                        <td align="center" valign="top"><?php echo  $agentRec['Agentnote']['timeStamp'];?></td>
                        <td align="center" valign="top"><?php echo  $common->getUserName($agentRec['Agentnote']['enteredBy']);?></td>
                        <td align="left" valign="top"><?php echo  $agentRec['Agentnote']['note'];  ?></td>
	                     <!-- <td align="left" valign="top">
                      	...
                      	<td align="center" valign="top"><?php echo $this->Html->image("delete_bt.png", array('alt'=>'Delete','title'=>'Delete','onclick'=>'return confirm("are you sure?");','url' => array('controller' => 'users', 'action' => 'deletenotes', 'delete',$agentRec['Agentnote']['agentNoteID'],$id))); ?> </td>
                       </tr>
                      <?php }?> 
                      <tr>
                      <td colspan="7">
