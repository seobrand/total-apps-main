...
Router::connect('/superadmin/contacts/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'contacts','superadmin'=>true));
...
//jitendra 17-july 13
Router::connect('/superadmin/reportsPermission', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'reports_permission','superadmin'=>true));
//jitendra 12-Dec 13
Router::connect('/superadmin/downloadapi', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'downloadapi','superadmin'=>true));