...
<div class="content"> 
  ...
  <div id="right">
    <div class="box">
      <div class="breadcrumb">Active Accounts By Processors</div>
      <div id="right2"> 
        <!-- table -->
        <?php /* task id 2579 point#7 by jitendra on 29 Nov 2013 ?>
        <div class="box1">
	  	<div class="news_indent"> 
	          <?php echo $this->Form->create('Report',array('action'=>'accsearchbyprocessor'));?>
	  ...
	  <?php */ ?>
        <div class="box1">
        <?php /*================== Ticket# 1043 point 4 (delete voluem report) ============================ ?>
          <!-- display box / first -->
          <div class="display_row padding_top_zero">
            <div class="table">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th align="center" valign="top" scope="col"><?php echo $this->Paginator->sort('User.user_Name', 'Processor');?> </th>
                ...
                <?php 
                	...
                	?>
		                <tr>
		                  ...
		                  <td align="center" valign="top"><?php if($preapp>0){ echo $this->Html->link("$ ".number_format($preapp,2),'/superadmin/merchants/viewbystatus?statusID=2&processorID='.$iso['User']['id']); }else{ echo "$ ".number_format($preapp,2);}?></td>
		                  <td align="center" valign="top"><?php if($incomplete>0){ echo $this->Html->link("$ ".number_format($incomplete,2),'/superadmin/merchants/viewbystatus?statusID=3&processorID='.$iso['User']['id']); }else{ echo "$ ".number_format($incomplete,2);}?></td>
		                  <td align="center" valign="top"><?php if($pending>0){ echo $this->Html->link("$ ".number_format($pending,2),'/superadmin/merchants/viewbystatus?statusID=4&processorID='.$iso['User']['id']); }else{ echo "$ ".number_format($pending,2);}?></td>
		                  <td align="center" valign="top"><?php if($integrating>0){ echo $this->Html->link("$ ".number_format($integrating,2),'/superadmin/merchants/viewbystatus?statusID=9&processorID='.$iso['User']['id']); }else{ echo "$ ".number_format($integrating,2);}?></td>
		                  <td align="center" valign="top"><?php if($processing>0){ echo $this->Html->link("$ ".number_format($processing,2),'/superadmin/merchants/viewbystatus?statusID=5&processorID='.$iso['User']['id']); }else{ echo "$ ".number_format($processing,2);}?></td>
		                  <td align="center" valign="top"><?php if($total>0){ echo $this->Html->link("$ ".number_format($total,2),'/superadmin/merchants/viewbystatus?statusID[]=2&statusID[]=3&statusID[]=4&statusID[]=5&statusID[]=9&processorID='.$iso['User']['id']); }else{ echo "$ ".number_format($total,2);}?></td>
                ...
                <?php 
                	...
                	foreach ($processors as $iso) { 
                                $preapp = $incomplete = $pending = $integrating = $processing = $total = 0;
                                    if(isset($result[$iso['User']['id']])){
                                        foreach($result[$iso['User']['id']] as $key => $Iso){
                                            if($key==2){
                                                $preapp = $Iso;
                                                $preappTotal += $preapp;
                                            }
                	...
                	?>
		                ...
		                <tr>
		                  <td align="center" valign="top"><?php echo $iso['User']['user_Name']; ?></td>
		                  <td align="center" valign="top"><?php if($preapp>0){ echo $this->Html->link($preapp,'/superadmin/merchants/viewbystatus?statusID=2&processorID='.$iso['User']['id']); }else{ echo $preapp;}?></td>
		                  <td align="center" valign="top"><?php if($incomplete>0){ echo $this->Html->link($incomplete,'/superadmin/merchants/viewbystatus?statusID=3&processorID='.$iso['User']['id']); }else{ echo $incomplete;}?></td>
		                  <td align="center" valign="top"><?php if($pending>0){ echo $this->Html->link($pending,'/superadmin/merchants/viewbystatus?statusID=4&processorID='.$iso['User']['id']); }else{ echo $pending;}?></td>
		                  <td align="center" valign="top"><?php if($integrating>0){ echo $this->Html->link($integrating,'/superadmin/merchants/viewbystatus?statusID=9&processorID='.$iso['User']['id']); }else{ echo $integrating;}?></td>
		                  <td align="center" valign="top"><?php if($processing>0){ echo $this->Html->link($processing,'/superadmin/merchants/viewbystatus?statusID=5&processorID='.$iso['User']['id']); }else{ echo $processing;}?></td>
		                  <td align="center" valign="top"><?php if($total>0){ echo $this->Html->link($total,'/superadmin/merchants/viewbystatus?statusID[]=2&statusID[]=3&statusID[]=4&statusID[]=5&statusID[]=9&processorID='.$iso['User']['id']); }else{ echo $total;}?></td>
