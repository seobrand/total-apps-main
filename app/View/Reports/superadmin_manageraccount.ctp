...
<div class="content"> 
  ...
  <div id="right">
    <div class="box">
      <div class="breadcrumb">SUM of Merchant Amount Processed</div>
      <div id="right2"> 
        <!-- table -->
        <div class="box1"> 
          ...
          <div class="display_row padding_top_zero">
            <div class="table">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th align="center" valign="top" scope="col"><?php echo $this->Paginator->sort('User.user_Name', 'Manager');?> </th>
          ...
          <!-- display box / first --> 
          <div class="breadcrumb">Count of Merchant Amount Processed</div>
           <!-- display box / first -->
          <div class="display_row padding_top_zero">
            <div class="table">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
