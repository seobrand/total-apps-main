...
<div class="content"> 
  ...
  <div id="right">
    <div class="box">
      <div class="breadcrumb">New Business Growth</div>
      <div id="right2"> 
        <!-- table -->
        <div class="box1">           
          <!-- display box / first -->
                	...
                	foreach ($merchants as $merchant) { 
                		...
                		if(count($merchant['Commissionlog'])>0){                			
                			foreach($merchant['Commissionlog'] as $commission){ 
                				$chkdate_cur_month = date('Y-m-01');
                				$chkdate_pre_month = date('Y-m-01', strtotime(date('Y-m')." -2 month"));
                				$chkdate_pre_to_pre_month = date('Y-m-01', strtotime(date('Y-m')." -2 month"));
