...
<div class="content"> 
  ...
  <div id="right">
    <div class="box">
      <div class="breadcrumb">Meritcard Chargeback Report</div>
      <div id="right2"> 
        <!-- table -->
        <div class="box1">  
        ...
        <div class="news_indent"> 
          <?php echo $this->Form->create('Report');?>
           <table width="100%" cellspacing="0" cellpadding="0" border="0" class="form_table">
              <tr height="35">
                <td width="10%" valign="top" align="right">Search Date</td>
                 ...
                 <td width="30%" valign="top" style="padding:0px;">
		 			<?php echo $this->Form->input('Year', array('dateFormat' => 'Y','type'	=> 'date',"empty"=>'Select Year','label'=>false,'div'=>false,'style'=>'width:290px;')); ?>
		 		 </td>
                 <td width="40%">&nbsp;</td>
              </tr>
              <tr height="35">
          ...
          <div class="display_row padding_top_zero">
            <div class="table table_scroll_autoy">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
			    ...
			    ?>
				    <tr>
				      <td align="center" valign="top"><?php echo $this->Html->link($data['Commissionlog']['MID'],array('controller'=>'reports','action'=>'meritcardreport/'.$data['Commissionlog']['MID'])); ?></td>
