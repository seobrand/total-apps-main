...
<div class="messages">
  ...
  <a class="close" style="color:#FF0000;float:right;"><?php echo $this->Html->image('close.png'); ?></a>
    <h3 style="font-family:Verdana, Arial, Helvetica, sans-serif;">Message</h3>
    
    <div class="success_text">
      <table cellpadding="0" cellspacing="0" border="0" width="" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;">
        <tr>
          <?php 
		 echo '<td style="background-color:#FFFFFF;border:none;">'.$this->Html->image('success.png',array('alt'=>'success','title'=>'success','style'=>'width:40px;'));
		  echo'</td><td style="background-color:#FFFFFF;border:none;">&nbsp;'.$this->Session->read('popup').'</td>';
  ...
  <?php   }
	  ...
	  <input type="hidden" name="popup_check" id="popup_check" value="no"/>
  	  <div id="popup_name" class="popup_block">
		<h3 style="font-family:Verdana, Arial, Helvetica, sans-serif;">Failure</h3>
		<div class="success_text">
		  <table cellpadding="0" cellspacing="0" border="0" width="" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;">
			<tr>
			  <?php 
			 echo '<td style="background-color:#FFFFFF;border:none;">'.$this->Html->image('error.png',array('alt'=>'Error','title'=>'Error','style'=>'width:40px;'));
			  echo'</td><td style="background-color:#FFFFFF;border:none;">&nbsp;'.$this->Session->read('popup').'</td>';
			  unset($_SESSION['popup']);
		?>
			</tr>
