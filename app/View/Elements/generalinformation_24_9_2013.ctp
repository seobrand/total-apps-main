            ...
            <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
              ...
              <tr>
                <td width="45%"  valign="top"><table width="100%" >
                    ...
                    <tr>
                      <td>User ID<span style="color:#FF0000">*</span></td>
                      <td><?php echo $this->Form->input('username',array('label'=>'','class'=>'input1'));?></td>
                    </tr>
                    <tr>
                      <td> Password<span style="color:#FF0000">*</span> </td>
                      <td><?php echo $this->Form->input('password',array('label'=>'','class'=>'input1' ));?> <?php echo $this->Form->input('old_password',array('label'=>'','class'=>'input1','type'=>'hidden','value'=>'hidden'));?> </td>
                    </tr>
                    <tr>
                ...
                <td  width="45%" valign="top"><table width="100%">
                    <?php 
						...
						if($value['user_group_id']==20 || $value['user_group_id']==25){ 
            	
					 if($i==1){ 
				 		if($value['user_group_id']==20){ ?>
                    <tr>
                      <td>Agent Split</td>
