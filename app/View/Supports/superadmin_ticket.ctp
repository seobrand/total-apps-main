					...
					<thead>
					 ...
					 ?>
                       ...
                       <td align="center">
							...
							<?php echo $this->Html->image("delete_bt.png", array('alt'=>'Delete','title'=>'Delete','onclick'=>'return confirm("Are you sure to delete this entry?");','url' =>array('controller'=>'supports','action'=>'deleteticket', $ticket['id'])));?>&nbsp;
...
function popClick(ticketID,userId){	
	...
	get_url = "<?php echo FULL_BASE_URL.router::url('/',false).'superadmin/supports/view_ticket_by_ajax/';?>";
...
function addComment(ticketID,status,type,userId){	
    $("#spinner").css("display", "block");
	get_url = "<?php echo FULL_BASE_URL.router::url('/',false).'superadmin/supports/edit_ticket_by_ajax/';?>";
