            ...
            <div class="news_indent">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table outer_form">
                ...
                <tr>
                  <td width="33%" align="left" valign="top" style="padding:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="left"  valign="middle">Date of Birth(MM/DD/YYYY)<br /><?php echo $this->Form->input('Owner.dob1',array('label'=>false,'class'=>'input1','div'=>false,'tabindex'=>70));?></td>
                      </tr>
                    </table></td>
                  <td width="33%" align="left" valign="top" style="padding:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                ...
                <tr>
                  <td width="33%" align="left" valign="top" style="padding:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="left"  valign="middle">Home Address<br /><?php echo $this->Form->input('Owner.homeAddress1',array('label'=>false,'class'=>'input1','div'=>false,'tabindex'=>70));?></td>
                      </tr>
                    </table></td>
                  <td width="33%" align="left" valign="top" style="padding:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
...
function validateForm(){
	...
	var ownername = document.getElementById('OwnerName1').value;
	var ownertitle = document.getElementById('OwnerTitle1').value;
	var ownership = document.getElementById('OwnerOwnership1').value;
	var licence = document.getElementById('OwnerLicenceNumber1').value;
	var socialsecurity = document.getElementById('OwnerSocialSecurityNumber1').value;
	var homephone = document.getElementById('OwnerHomePhone1').value;
	...
	/*if(tradename==''){
		errormessge += "Please enter Trade name\n";
	}
	if(bankname==''){
		errormessge +=  "Please enter Bank name\n";
	}
	if(tradecontact==''){
		errormessge +=  "Please enter trade contact name\n";
	}
	if(bankcontact==''){
		errormessge +=  "Please enter bank contact name\n";
	}
	if(tradephone==''){
		errormessge +=  "Please enter trade phone number\n";
	}
	if(bankphone==''){
		errormessge +=  "Please enter bank phone number\n";
	}*/
	if(bankingcontact==''){
	...
	for(i=1;i<=cnt;i++){
		...
		if(document.getElementById('OwnerSocialSecurityNumber'+i).value==''){
			errormessge += "Please Enter Owner Social Security Number\n";			
		}
		if(document.getElementById('OwnerHomePhone'+i).value==''){
			errormessge += "Please Enter Owner Home Phone\n";		
		}
	}
