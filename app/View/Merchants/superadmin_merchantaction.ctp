...
function sendapplication(){
	var email=$('#MerchantSendFrom').val();
	email=email.trim();
              ...
              <div class="news_announcement">
                ...
                <div id="send-app" <?php if(strtolower($processor)=='mojopay' || strtolower($processor)=='mojo pay' || strtolower($processor)=='mp' || strtolower($processor)=='mojo-pay'){?> style="display: none;" <?php }?>>
                  ...
                  <?php if(strtolower($processor)=='mojo pay' || strtolower($processor)=='mojopay'){
					...
					?>
                  <?php  echo $this->Form->create('Merchant',array('controller'=>'merchants','action'=>'merchantaction','type'=>'file','onsubmit'=>'return sendapplication();')); ?>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable">
                    <tr>
                      ...
                      <td width="92%" align="left" valign="middle"><table  border="0">
                          <?php echo $this->Form->input("Merchant.appFrom",array('type'=>'hidden','value'=>''));?>
                          <tr>
                            <td><?php echo $this->Form->input('Merchant.sendFrom', array('label'=>'','value'=>$email_from));?></td>
                            <td><?php echo $this->Form->input('Merchant.manager', array('label'=>'Manager','type'=>'checkbox','value'=>$this->request->data['Manager']['userEmail'],'checked'=>true));?></td>
                            <td><?php echo $this->Form->input('Merchant.iso', array('label'=>'ISO','type'=>'checkbox','value'=>$this->request->data['ISO']['userEmail']));?></td>
                            <td><?php echo $this->Form->input('Merchant.Agent', array('label'=>'Agent','type'=>'checkbox','value'=>$this->request->data['Agent']['userEmail']));?> </td>
                            <td><?php echo $this->Form->input('Merchant.referral', array('label'=>'Referral','type'=>'checkbox','value'=>$this->request->data['Referal']['userEmail']));?> </td>
                          </tr>
                          <tr>
                            <td>CC:<?php echo $this->Form->input('Merchant.cc_email', array('label'=>false,'div'=>false));?> </td>
                            <td colspan="4">BCC:<?php echo $this->Form->input('Merchant.bcc_email', array('label'=>false,'div'=>false));?> </td>
                          </tr>
                        </table></td>
                    </tr>
                    <?php /* ticket id 2913 */?>
                    <tr>
                      <td colspan="2" align="left" valign="top" style="padding-left:15px;"> Upload multiple document from here <?php echo $this->Form->input('MerchantAddDoc.', array('label'=>false,'div'=>false,'type'=>'file','multiple'));?> </td>
                  	</tr>
                    <tr>
                  ...
                  <?php echo $this->Form->input('Merchant.merchantID',array('type' => 'hidden','value'=>$this->request->data['Merchant']['id']));?>
                  <?php echo $this->Form->input('Processor.Package',array('type' => 'hidden','value'=>$this->request->data['Processor']['processorPackage']));?>
                  <?php echo $this->Form->input('Processor.Filename',array('type' => 'hidden','value'=>$this->request->data['Processor']['processorPackageFilename']));?> 
                ...
                <div id="incomplete-doc" style="display:none;">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable">
                    ...
                    <?php /* ticket id 2913 */?>
                    <tr>
                      <td width="15%" align="left" valign="middle">Upload multiple document from here:</td>
                      <td width="85%" align="left" valign="middle"> <?php echo $this->Form->input('MerchantAddDoc.', array('label'=>false,'div'=>false,'type'=>'file','multiple'));?> </td>
                  	</tr>
                    <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable">
                  <tr>
                    <td align="left" valign="middle"><strong>Send Bad URL email</strong><br/>
                      ...
                      <br/>
                      <?php /* ticket id 2913 */?>
                      Upload multiple document from here <?php echo $this->Form->input('MerchantAddDoc.', array('label'=>false,'div'=>false,'type'=>'file','multiple'));?>
                       <br/><br/>
                  ...
                  <tr>
                    <td class="bodyTextA"><b>Send Processor Pre-App Approval</b><br>
                      ...
                      *If there is a processor missing, either they are 'inactive' OR they do not have an email address in the system. <br>
                      ...
                      <?php /* ticket id 2913 */?>
                        <tr>
	                      <td colspan="4"> Upload multiple document from here <?php echo $this->Form->input('MerchantAddDoc.', array('label'=>false,'div'=>false,'type'=>'file','multiple'));?> </td>
	                  	</tr>
                        <tr>
                          <?php  
								   $i=1;
              ...
              <div id="send_application_to_processor" style="display:none;">
                ...
                <?php /* ticket id 2913 */?>
                  ...
                  <tr>
                    ...
                    <?php echo $this->Form->input('Merchant.Message', array('label'=>'','type' => 'textarea','class'=>'textarea1 mceNoEditor','value'=>"Hello,
...
(949) 266-8260 Fax"));?></td>
              ...
              <div id="other_email_templates" style="display:none;">
                <?php  echo $this->Form->create('Merchant',array('controller'=>'merchants','action'=>'merchantaction','id'=>'othr_email_template','onsubmit'=>'return othr_email_template_validation()','type'=>'file')); ?>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable">
                  <tr>
...
<script type="text/javascript">
	function showMerchantActions(showId){
		...
		if(showId=='send-app' || showId=='MojoPay' || showId=='MeritCard'){
			...
			document.getElementById('MerchantAppFrom').value = showId;
