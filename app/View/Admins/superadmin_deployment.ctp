...
<div class="content">
  ...
  <div id="right">
    ...
    <div id="right2">
      <!-- table -->
      <div class="box1"><div class="titlebar">DEPLOYMENT INFORMATION</div>
        <!-- display box / first -->
        <div class="display_row">
          
          <?php  echo $this->Form->create('Admin',array('controller'=>'admins','action'=>'deployment')); ?>
          <div class="tabs_des">
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    <tr>
                      <td><?php echo $this->Form->radio('Deployment.terminalPrograming', array('Retail' => 'Retail', 'Tips' => 'Tips', 'MOTO/Internet Gateway' => 'MOTO/Internet Gateway', 'Lodging' => 'Lodging **', 'Petroleum' => 'Petroleum **', 'Cash Advance' => 'Cash Advance ***'),array('legend' => false,'separator' => '<br/><br/>', 'between' => '&nbsp;&nbsp;'));?></td>
                    </tr>
                    <tr>
                      <td colspan="2" align="left" valign="top"><p>** Requires special application olny available on certain terminals, so be sure to check with powerpay.</p>
                        <p>*** Only available for financial institutions and special paperwork is required. Requires a verifone Tranz 330 and printer.</p></td>
                    </tr>
                  </table>
                </div>
              </div>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      ...
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.trainingGivenBy1', array('powerpay' => 'Powerpay', 'agent' => 'Agent', 'other' => 'Other'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Supplier: </td>
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.supplier1', array('Merchant Owned' => 'Merchant Owned', 'Agent Supplied' => 'Agent Supplied', 'Form Powerpay' => 'Form Powerpay'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><em> * These options are not available on all terminals. please check with powerpay to ensure compatibility. </em></td>
                    </tr>
                    <tr>
                      ...
                      <input type="hidden" value="<?php if(count($TeminalData)>1) echo count($TeminalData); else echo "1"; ?>" id="TerminalsoftgatewayCount" name="data[Terminalsoftgateway][count]">
                    </tr>
                  </table>
                </div>
                <?php if(count($TeminalData)>1){ 
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Traning will be done by: </td>
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.trainingGivenBy'.($key+1), array('powerpay' => 'Powerpay', 'agent' => 'Agent', 'other' => 'Other'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Supplier: </td>
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.supplier'.($key+1), array('Merchant Owned' => 'Merchant Owned', 'Agent Supplied' => 'Agent Supplied', 'Form Powerpay' => 'Form Powerpay'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%"  align="left" valign="middle" class="rpadnone"> Options *: </td>
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addTerminalFormField()">Add another terminal, software, or gateway</a> (up to four) &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link('Remove', array('controller' => 'admins','action' => 'terminalsoftwaredelete', $terminal['Terminalsoftgateway']['id'], $terminal['Terminalsoftgateway']['merchantID'])); ?> </td>
                    </tr>
                  </table>
                </div>
                <?php } } }?>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Supplier:</td>
                      <td colspan="3"><?php echo $this->Form->radio('Printer.printerSupplier1', array('Merchant Owned' => 'Merchant Owned', 'Agent Supplied' => 'Agent Supplied', 'Form Powerpay' => 'Form Powerpay'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <input type="hidden" value="<?php if(count($PrinterData)>1) echo count($PrinterData); else echo "1"; ?>" id="PrinterCount" name="data[Printer][count]">
                    </tr>
                  </table>
                </div>
                <?php if(count($PrinterData)>1){ 
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Supplier:</td>
                      <td colspan="3"><?php echo $this->Form->radio('Printer.printerSupplier'.($key+1), array('Merchant Owned' => 'Merchant Owned', 'Agent Supplied' => 'Agent Supplied', 'Form Powerpay' => 'Form Powerpay'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> New or refurbished:</td>
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addPrinterFormField()">Add another printer</a> (up to four) &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link('Remove', array('controller' => 'admins','action' => 'printerdelete', $printer['Printer']['id'], $printer['Printer']['merchantID'])); ?></td>
                    </tr>
                  </table>
                </div>
                <?php } } }?>
            ...
            <div class="box1">
              <div class="news_announcement">
                ...
                <div class="news_indent">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    <tr>
                      <td><?php echo $this->Form->radio('Deployment.pinPad', array('Terminal to be internally encrypted' => 'Terminal to be internally encrypted', 'Terminal to be have an external pin pad attached' => 'Terminal to be have an external pin pad attached'),array('legend' => false,'separator' => '<br/><br/>', 'between' => '&nbsp;&nbsp;'));?></td>
                    </tr>
                  </table>
                </div>
              </div>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Supplier:</td>
                      <td colspan="3"><?php echo $this->Form->radio('Checkreader.readerSupplier1', array('Merchant Owned' => 'Merchant Owned', 'Agent Supplied' => 'Agent Supplied', 'Form Powerpay' => 'Form Powerpay'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> New or refurbished:</td>
                    ...
                    <tr>
                      ...
                      <input type="hidden" value="<?php if(count($CheckReaderData)>1) echo count($CheckReaderData); else echo "1"; ?>" id="CheckreaderCount" name="data[Checkreader][count]">
                    </tr>
                  </table>
                </div>
                <?php if(count($CheckReaderData)>1){ 
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Supplier:</td>
                      <td colspan="3"><?php echo $this->Form->radio('Checkreader.readerSupplier'.($key+1), array('Merchant Owned' => 'Merchant Owned', 'Agent Supplied' => 'Agent Supplied', 'Form Powerpay' => 'Form Powerpay'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> New or refurbished:</td>
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addReaderFormField()">Add another check reader</a> (up to four) &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link('Remove', array('controller' => 'admins','action' => 'checkreaderdelete', $readerdata['Checkreader']['id'], $readerdata['Checkreader']['merchantID'])); ?></td>
                    </tr>
                  </table>
                </div>
                <?php } } }?>
            ...
            <div class="box1">
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone">Powerpay Sends welcome kits for each merchant, regardiess of who supplies the equipment.  Please let us know how, or if, you want the kit Shipped.</td>
                    </tr>
                    <tr>
                      <td colspan="5"><?php echo $this->Form->radio('Deployment.shippingInfo', array('Ground' => 'Ground', '2nd day' => '2nd day', 'Overnight' => 'Overnight', 'Saturday Delivery' => 'Saturday Delivery', 'No Kit Necessary' => 'No Kit Necessary *'),array('legend' => false,'separator' => '<br/><br/>', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="2" align="left" valign="middle" style="padding:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><?php echo $this->Form->radio('Deployment.shippingInfoOther', array('Ship to DBA Address' => 'Ship to DBA Address', 'Ship to Other' => 'Ship to Other'),array('legend' => false,'separator' => '<br/><br/>', 'between' => '&nbsp;&nbsp;'));?></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone">* Powerpay will normally not ship a kit for an ecommerce merchant, but we will send a welcome letter via email.</td>
                    </tr>
                  </table>
                </div>
              </div>
            ...
            <div class="box1">
              <div class="news_announcement">
                ...
                <div class="news_indent">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    <tr>
                      <td><?php echo $this->Form->radio('Deployment.billingInfo', array('No Billing Required' => 'No Billing Required', 'Bill Agent' => 'Bill Agent', 'Bill Merchant' => 'Bill Merchant'),array('legend' => false,'separator' => '<br/><br/>', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><span class="gray">1000 Characters remaining</span></td>
                    </tr>
                  </table>
                </div>
              </div>
            ...
            <?php echo $this->Form->input('Deployment.userType', array('type' => 'hidden','value'=>$this->request->data['Deployment']['userType']));?>  <?php echo $this->Form->input('Deployment.id', array('type' => 'hidden','value'=>$ID));?>
...
var i = count+1;
	if(count<=3){
		content += '<div class="news_indent_addmore"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg"><tr><td align="left" valign="middle" class="rpadnone"> Terminal, Softwrare, or gateway: </td><td colspan="4" align="left" valign="middle"><input type="text" id="TerminalsoftgatewaySoftwareName'+i+'" class="input2" name="data[Terminalsoftgateway][softwareName'+i+']"></td></tr><tr><td width="23%" align="left" valign="middle" class="rpadnone"> Traning will be done by: </td><input type="hidden" value="" id="TerminalsoftgatewayTrainingGivenBy_" name="data[Terminalsoftgateway][trainingGivenBy'+i+']"><td width="15%" align="left" valign="middle"><input type="radio" value="powerpay" id="TerminalsoftgatewayTrainingGivenByPowerpay" name="data[Terminalsoftgateway][trainingGivenBy'+i+']"  />Powerpay</td><td width="14%" align="left" valign="middle"><input type="radio" value="agent" id="TerminalsoftgatewayTrainingGivenByAgent" name="data[Terminalsoftgateway][trainingGivenBy'+i+']"  />Agent</td><td colspan="2" align="left" valign="middle"><input type="radio" value="other" id="TerminalsoftgatewayTrainingGivenByOther" name="data[Terminalsoftgateway][trainingGivenBy'+i+']"  />Other</td></tr><tr><td align="left" valign="middle" class="rpadnone"> Supplier: </td><input type="hidden" value="" id="TerminalsoftgatewaySupplier_" name="data[Terminalsoftgateway][supplier'+i+']"><td align="left" valign="middle"><input type="radio" value="Merchant Owned" id="TerminalsoftgatewaySupplierMerchantOwned" name="data[Terminalsoftgateway][supplier'+i+']"  />Merchant Owned</td><td align="left" valign="middle"><input type="radio" value="Agent Supplied" id="TerminalsoftgatewaySupplierAgentSupplied" name="data[Terminalsoftgateway][supplier'+i+']"  />Agent Supplied</td><td colspan="2" align="left" valign="middle"><input type="radio" value="Form Powerpay" id="TerminalsoftgatewaySupplierFormPowerpay" name="data[Terminalsoftgateway][supplier'+i+']"  />Form Powerpay</td></tr><tr><td align="left" valign="middle" class="rpadnone"> Options *: </td><td align="left" valign="middle"><input type="checkbox" value="Process via IP" id="TerminalsoftgatewayOptionsProcessViaIP" name="data[Terminalsoftgateway][options'+i+'][]"  />Process via IP</td><td align="left" valign="middle"><input type="checkbox" value="Wireless" id="TerminalsoftgatewayOptionsWireless" name="data[Terminalsoftgateway][options'+i+'][]"  />Wireless</td><td width="17%" align="left" valign="middle"><input type="checkbox" value="Store and forward" id="TerminalsoftgatewayOptionsStoreAndForward" name="data[Terminalsoftgateway][options'+i+'][]"  />Store and forward</td><td width="31%" align="left" valign="middle"><input type="checkbox" value="Timed upload" id="TerminalsoftgatewayOptionsTimedUpload" name="data[Terminalsoftgateway][options'+i+'][]"  />Timed upload</td></tr><tr><td colspan="5" align="left" valign="middle" class="rpadnone"><em> * These options are not available on all terminals. please check with powerpay to ensure compatibility. </em></td></tr><tr><td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addTerminalFormField()">Add another terminal, software, or gateway</a> (up to four) </td><input type="hidden" value="'+i+'" id="TerminalsoftgatewayCount" name="data[Terminalsoftgateway][count]"></tr></table></div>';
