<div class="content">
  ...
  <div id="right">
    ...
    <div id="right2">
      <!-- table -->
      <div class="box1">  <div class="titlebar">ADMIN TRANSACTION</div>
        <!-- display box / first -->
        <div class="display_row">
          <div class="tabs_des">
  		  <?php  echo $this->Form->create('Admin',array('controller'=>'admins','action'=>'transaction','onsubmit'=>'return validateTransaction();','name'=>'transaction'))?> 
            <div class="box1">
                ...
                <div class="news_indent">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
					...
					<tr>
                      ...
                      <td align="left" valign="middle"><?php echo $this->Form->submit('Update Transaction',array('name'=>'Submit','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false));?></td>
                    </tr>
                  </table>
                </div>
              </div>
