    ...
    <div id="right2">
      ...
      <div class="box1">
        <div class="news_announcement">
          <div class="titlebar">Edit email Template
            <div style="float:right">
         	<a href="<?php echo $prePage; ?>"><?php echo $this->Html->image('back.png',array('title' => 'Back'));?></a>
            </div>
          </div>
          <div class="box">
            <div class="display_row"> <?php echo $this->Form->create('EmailTemplate', array('action'=>'editTemplate','id'=>'form','enctype'=>'multipart/form-data'));?>
              <table border="0" cellspacing="0" cellpadding="0" id="login" align="center">
                <tr>
                  ...
                  <td align="left" valign="top"><?php echo $this->Form->input('title', array('label'=>'','id'=>'title','class'=>'input2','div'=>false,'style'=>'width:415px;height:15px;')); ?> </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><table cellpadding="0" cellspacing="0" border="0" class="nostyle" >
                      <tr>
                        <td><?php echo $this->Form->input('message', array('label'=>'','type'=>'textarea','cols'=>'80','rows'=>'20','id'=>'message')); ?> </td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
