<?php 
if(is_array($TeminalData) && count($TeminalData)>0){
...
if(is_array($PrinterData) && count($PrinterData)>0){
...
if(is_array($CheckReaderData) && count($CheckReaderData)>0){
...
<div class="content">
  ...
  <div id="right">
    ...
    <div id="right2">
      ...
      <div class="titlebar">DEPLOYMENT INFORMATION
	  <div style="float:right">
         	<a href="<?php echo $this->webroot; ?>superadmin/deployments/deploymentlist/"><?php echo $this->Html->image('back.png',array('title' => 'Back'));?></a>
        </div>
		</div>
        <!-- display box / first -->
        <div class="display_row">
          
          <?php  echo $this->Form->create('Deployment',array('controller'=>'deployments','action'=>'deployment')); ?>
		  	...
		  	<div class="news_announcement">
                ...
                <div class="news_indent">
                    ...
                    <tr>
						...
						<td><?php echo $this->Form->input('Deployment.adminName',array('label'=>false,'class'=>'input1','div'=>false));?></td>
                    </tr>
                  </table>
				</div>
			</div>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td colspan="2" align="left" valign="top"><p>** Requires special application olny available on certain terminals, so be sure to check with totalapps.</p>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      ...
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.trainingGivenBy1', array('totalapps' => 'Total-Apps', 'agent' => 'Agent', 'other' => 'Other'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Terminal provided by</td>
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.supplier1', array( 'Totalapps' => 'Total-Apps','Merchant' => 'Merchant', 'Agent' => 'Agent'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Traning will be done by</td>
                      <td colspan="3"><?php echo $this->Form->radio('Terminalsoftgateway.trainingGivenBy'.($key+1), array('totalapps' => 'Total-Apps', 'agent' => 'Agent', 'other' => 'Other'),array('legend' => false,'separator' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', 'between' => '&nbsp;&nbsp;'));?> </td>
                    </tr>
                    <tr>
                      <td width="23%" align="left" valign="middle" class="rpadnone"> Terminal provided by</td>
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addTerminalFormField()">Add another terminal, software, or gateway</a> (up to four) &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link('Remove', array('controller' => 'deployments','action' => 'terminalsoftwaredelete', $terminal['Terminalsoftgateway']['id'], $terminal['Terminalsoftgateway']['merchantID'])); ?> </td>
                    </tr>
                  </table>
                </div>
                <?php } } }?>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addPrinterFormField()">Add another printer</a> (up to four) &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link('Remove', array('controller' => 'deployments','action' => 'printerdelete', $printer['Printer']['id'], $printer['Printer']['merchantID'])); ?></td>
                    </tr>
                  </table>
                </div>
                <?php } } }?>
              ...
              <div class="news_announcement">
                ...
                <div class="news_indent_addmore">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="no_bg">
                    ...
                    <tr>
                      <td colspan="5" align="left" valign="middle" class="rpadnone"><a href="javascript:void(0)" onclick="addReaderFormField()">Add another check reader</a> (up to four) &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link('Remove', array('controller' => 'deployments','action' => 'checkreaderdelete', $readerdata['Checkreader']['id'], $readerdata['Checkreader']['merchantID'])); ?></td>
                    </tr>
                  </table>
                </div>
                <?php } } }?>
            ...
            <?php echo $this->Form->input('Deployment.userType', array('type' => 'hidden','value'=>$userType));?> 
			 <?php echo $this->Form->input('Deployment.id', array('type' => 'hidden','value'=>$ID));?>
			 
            <div style="float:right; margin-right:10px;">
			 <?php if($ID!=''){ echo $this->Form->submit('Update Deployment',array('name'=>'Submit','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false)); }else{ echo $this->Form->submit('Add Deployment',array('name'=>'Submit','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false)); }?>
			</div>
