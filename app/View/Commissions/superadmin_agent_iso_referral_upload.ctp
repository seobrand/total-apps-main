    ...
    <div id="right2">
      ...
      <div class="box1">
        <div class="news_announcement">
           <div class="titlebar">Upload Agent/ISO/Referral Data For Merchants</div>
		        ...
		        <div class="news_announcement">
		          ...
		          <?php if(count($mids)>0){?>
		          	<div class="box"><div class="breadcrumb">Records Not Matching MIDs #</div>
			            ...
			            <?php echo $this->Form->create("Commission",array('action'=>'userdataexport'));?>
			              <div class="table">			              
							<div style="max-height:390px;overflow:auto;">
								<table width="100%" class="cg_table">
									...
									<?php foreach($mids as $key => $xlsValue){?>
										...
										<?php $finalMidsArray[$xlsValue[0]] = array($xlsValue[1],$xlsValue[2],$xlsValue[3]);?>
									<?php }?>								
								</table>
							</div>
			          ...
			          <div class="box">
			            <div class="display_row">
			              <div class="table">
			              <?php echo $this->Form->create("Commission",array('action'=>'userdata_approve'));?>
			              <div style="max-height:340px;overflow:auto;">
							<table width="100%" class="cg_table">
								...
								<?php foreach($merchants as $key => $xlsValue){?>
									...
									<?php $finalArray[] = array($xlsValue['id'],$xlsValue[0],$xlsValue[1],$xlsValue[2],$xlsValue[3]);?>									
								<?php }?>
								<?php if($total_exist==0){?>
									<tr class="cg_row">
									  <td align="center" colspan="5">MID# in this xls file are not matching in database.</td>
									</tr>
								<?php }?>
							</table>
							</div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table" align="center">
				                ...
				                <?php }?>
				                  ...
				                  <td <?php if($total_exist>0){?> width="50%" align="left" <?php }else{?> width="100%" align="center"<?php }?>>
				                  	  ...
				                  	  <?php echo $this->Form->create("Commission",array('action'=>'agent_iso_referral_upload','type'=>'get'));?>
