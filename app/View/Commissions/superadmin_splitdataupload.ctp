    ...
    <div id="right2">
      ...
      <div class="box1">
        <div class="news_announcement">
           <div class="titlebar">Add New Split % data
		        ...
		        <div class="news_announcement">
		          ...
		          <?php if(count($mids)>0){?>
		          	<div class="box"><div class="breadcrumb">Records Not Matching MIDs #</div>
			            ...
			            <?php echo $this->Form->create("Commission",array('action'=>'splitdataexport'));?>
			              <div class="table">			              
							<div style="max-height:390px;overflow:auto;">
								<table width="100%" class="cg_table">
									<tr class="cg_header">
									  ...
									  <th>Agent % Split</th>
									  <th>ISO % Split</th>
									  <th>Referral % Split</th>
									  <th>Totalapps % Split</th>
									  <?php /*?><th>Date</th><?php */?>
									...
									<?php foreach($mids as $key => $xlsValue){?>
										<tr class="cg_row">
											...
											<?php /*?><td align="center"><?php echo date("m/d/Y",strtotime($xlsValue[5]));?></td><?php */?>
											<td align="center"><input type="checkbox" value="<?php echo $xlsValue[0];?>" name="data[Commission][checkMid][]"></td>
										</tr>
										<?php $finalMidsArray[$xlsValue[0]] = array($xlsValue[1],$xlsValue[2],$xlsValue[3],$xlsValue[4],strtotime($xlsValue[5]));?>
									<?php }?>								
								</table>
							</div>
			          ...
			          <div class="box">
			            <div class="display_row">
			              <div class="table">
			              <?php echo $this->Form->create("Commission",array('action'=>'splitdata_approve'));?>
			              <div style="max-height:340px;overflow:auto;">
							<table width="100%" class="cg_table">
								...
								<?php foreach($merchants as $key => $xlsValue){?>
									...
									<?php $finalArray[] = array($xlsValue['id'],$xlsValue[0],$xlsValue[1],$xlsValue[2],$xlsValue[3],$xlsValue[4],strtotime($xlsValue[5]));?>									
								<?php }?>
								<?php if($total_exist==0){?>
									<tr class="cg_row">
									  <td align="center" colspan="7">MID# in this xls file are not matching in database.</td>
									</tr>
								<?php }?>
							</table>
							</div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table" align="center">
				                ...
				                <?php }?>
				                  ...
				                  <td <?php if($total_exist>0){?> width="50%" align="left" <?php }else{?> width="100%" align="center"<?php }?>>
				                  	  ...
				                  	  <?php echo $this->Form->create("Commission",array('action'=>'splitdataupload','type'=>'get'));?>
