...
<?php  echo $this->Form->create('Api',array('controller'=>'apis','action'=>'apiprofileinfo','onsubmit'=>'return validateForm()')); ?>
              ...
              <div class="product_search_indent">
                ...
                <span class="validation_info">&nbsp;* All fields marked with a red asterisk character are mandatory.</span>
                  <table class="applicationform_table  table_font" style="width:95%">
                    ...
                    <tr>
                      <td>Refund policy:<br>
                       <?php echo $this->Form->input('Merchant.describePolicy',array('type'=>'select','label'=>false,'class'=>'input_start selectbox','div'=>false,'options'=>array('All Sales Final'=>'All Sales Final','7 Days'=>'7 Days','14 Days'=>'14 Days','21 Days'=>'21 Days','Upon Request'=>'Upon Request','Upon Return of Product'=>'Upon Return of Product','Case-by-Case'=>'Case-by-Case','Other'=>'Other')));?>
                      </td>
                      <td>
                  ...
                  <div class="product_search_title">Trade References</div>
                  ...
                  <table class="applicationform_table" style="width:95%">
                    ...
                    <tr>
	                    <td >
	                    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                    	<tr>
	                            	<td> <span class="validation_info">*</span>Bank Contact (either your personalbanker or bank’s name):<br>
            ...
            <br /><br />
               <?php echo $this->Form->submit('/img/online_appform/next-bt.jpg',array('div'=>false,'style'=>'margin-right:84px;')); ?>
               <br /><br />
            </div>
