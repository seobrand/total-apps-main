      ...
      <div class="box1">
        <div class="news_announcement">
          ...
          <div class="news_indent">
            <?php  echo $this->Form->create('Usercat',array('controller'=>'usercats','action'=>'editusercat')); ?>
            <div class="news_indent">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="no_bg">
			   ...
			   <?php echo $this->Form->input('Usercat.id', array('type' => 'hidden','value'=>$this->request->data['Usercat']['id']));?>
			  </div>
